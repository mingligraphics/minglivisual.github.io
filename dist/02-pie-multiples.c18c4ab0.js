...
},{}],"scripts/homework-13/02-pie-multiples.js":[function(require,module,exports) {
"use strict";
...
var colorScale = d3.scaleOrdinal().range(['#98DC4B', '#c994c7', '#fec44f']);
var pieScale = d3.scalePoint().range([0, width]).padding(0.5); // Read in files
...
function ready(datapoints) {
  ...
  var colorNames = datapoints.map(function (d) {
    return d.task;
  });
  ...
  svg.selectAll('g').data(nested).enter().append('g').attr('transform', function (d) {
    return "translate(".concat(pieScale(d.key), ",100)");
  }).each(function (d) {
    var name = d.key;
    ...
    g.selectAll('.title').data(pie(datapoints)).enter().append('text').text(name).attr('transform', function (d) {
      return "translate(".concat(pieScale(d.key), ",0)");
    }).attr('dy', 120).attr('dx', -20);
  });
}
},{"d3":"../node_modules/d3/index.js","/data/time-breakdown-all.csv":"data/time-breakdown-all.csv"}]},{},["scripts/homework-13/02-pie-multiples.js"], null)
//# sourceMappingURL=/02-pie-multiples.c18c4ab0.js.map