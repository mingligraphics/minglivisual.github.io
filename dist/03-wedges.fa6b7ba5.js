...
},{}],"scripts/homework-13/03-wedges.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#chart-3').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')').attr('transform', "translate(".concat(width / 2, ",").concat(height / 2, ")"));
...
function ready(datapoints) {
  ...
  svg.append('text').text('NYC high temperatures, by month').attr('fill', 'black').attr('stroke', 'none').attr('font-weight', '500').style('font-size', '26px').attr('transform', 'translate(-190,-130)');
}
},{"d3":"../node_modules/d3/index.js","/data/ny-temps.csv":"data/ny-temps.csv"}]},{},["scripts/homework-13/03-wedges.js"], null)
//# sourceMappingURL=/03-wedges.fa6b7ba5.js.map