...
},{}],"scripts/homework-13/06-radar.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#chart-6').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
d3.csv(require('/data/ratings.csv')).then(ready).catch(function (err) {
  return console.log('Failed with', err);
});

function ready(datapoints) {}
},{"d3":"../node_modules/d3/index.js","/data/ratings.csv":"data/ratings.csv"}]},{},["scripts/homework-13/06-radar.js"], null)
//# sourceMappingURL=/06-radar.92f9f47e.js.map