...
Promise.all([d3.csv(require('/data/ces.csv')), d3.csv(require('/data/wages.csv'))]).then(ready).catch(function (err) {
...
},{"d3":"../node_modules/d3/index.js","/data/ces.csv":"data/ces.csv","/data/wages.csv":"data/wages.csv"}]},{},["scripts/homework-15/04-chart.js"], null)
//# sourceMappingURL=/04-chart.967ba3e5.js.map